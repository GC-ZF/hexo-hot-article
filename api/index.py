...
from Site_Analytics.baidu.baidu import baidu_get_token, baidu_refresh_token, get_hot_post, \
...
@app.get ( "/get_all/" )
async def get_all(url: str = '域名/get_all?url=博客地址'):
    '''
    获取博客所有信息
    :param url: 博客url
...
@app.get ( "/get_post/", response_class=HTMLResponse )
async def get_post(url: str = '域名/get_post?url=文章地址'):
    '''
    获取单篇文章信息
    :param url: 文章地址
    :return: 文章内容
...
@app.get ( "/get_hot_post/" )
async def get_hot_posts(access_token: str, url: str):
    '''
    获取博客热文统计
    ...
    '''
    return get_hot_post ( access_token, url )


# get_visitor_province和get_visitor_counrty返回信息格式还没想好！！！
